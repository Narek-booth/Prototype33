...
class CommitmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create commitment" do
    assert_difference('Commitment.count') do
      post commitments_url, params: { commitment: { causes_id: @commitment.causes_id, description: @commitment.description, donation_size: @commitment.donation_size, owner_id: @commitment.owner_id, status: @commitment.status, target: @commitment.target } }
    end
  ...
  test "should update commitment" do
    patch commitment_url(@commitment), params: { commitment: { causes_id: @commitment.causes_id, description: @commitment.description, donation_size: @commitment.donation_size, owner_id: @commitment.owner_id, status: @commitment.status, target: @commitment.target } }
