...
class FavoritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favorite" do
    assert_difference('Favorite.count') do
      post favorites_url, params: { favorite: { cause_id: @favorite.cause_id, owner_id: @favorite.owner_id } }
    end
  ...
  test "should update favorite" do
    patch favorite_url(@favorite), params: { favorite: { cause_id: @favorite.cause_id, owner_id: @favorite.owner_id } }
